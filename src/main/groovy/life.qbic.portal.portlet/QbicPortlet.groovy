...
/**
 * Entry point for portlet Sample_Tracking_Status_Overview. This class derives from {@link QBiCPortletUI}, which is found in the {@code portal-utils-lib} library.
 *
